<?
    ...
    $arr_sql[]="ALTER TABLE `tbl_conversions`  ADD `txt_param1` TEXT,  ADD `txt_param2` TEXT,  ADD `txt_param3` TEXT ,  ADD `txt_param4` TEXT ,  ADD `txt_param5` TEXT ,  ADD `txt_param6` TEXT ,  ADD `txt_param7` TEXT ,  ADD `txt_param8` TEXT ,  ADD `txt_param9` TEXT ,  ADD `txt_param10` TEXT ,  ADD `txt_param11` TEXT ,  ADD `txt_param12` TEXT ,  ADD `txt_param13` TEXT ,  ADD `txt_param14` TEXT ,  ADD `txt_param15` TEXT ,  ADD `txt_param16` TEXT ,  ADD `txt_param17` TEXT ,  ADD `txt_param18` TEXT ,  ADD `txt_param19` TEXT ,  ADD `txt_param20` TEXT ,  ADD `float_param1` FLOAT(10,4) ,  ADD `float_param2` FLOAT(10,4) ,  ADD `float_param3` FLOAT(10,4) ,  ADD `float_param4` FLOAT(10,4) ,  ADD `float_param5` FLOAT(10,4) ,  ADD `int_param1` INT(11) ,  ADD `int_param2` INT(11) ,  ADD `int_param3` INT(11) ,  ADD `int_param4` INT(11) ,  ADD `int_param5` INT(11) ,  ADD `int_param6` INT(11) ,  ADD `int_param7` INT(11) ,  ADD `int_param8` INT(11) ,  ADD `int_param9` INT(11) ,  ADD `int_param10` INT(11) ,  ADD `int_param11` INT(11) ,  ADD `int_param12` INT(11) ,  ADD `int_param13` INT(11) ,  ADD `int_param14` INT(11) ,  ADD `int_param15` INT(11) ,  ADD `int_param16` INT(11) ,  ADD `int_param17` INT(11) ,  ADD `int_param18` INT(11) ,  ADD `int_param19` INT(11) ,  ADD `int_param20` INT(11) ,  ADD `date_param1` INT ,  ADD `date_param2` DATETIME ,  ADD `date_param3` DATETIME ,  ADD `date_param4` DATETIME ,  ADD `date_param5` DATETIME ";
